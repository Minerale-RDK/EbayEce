        ...
        <div calss="row"> 
            <div class="col-lg-10 col-xl-9 mx-auto" >
               <div class="card card-signin flex-row my-5" >
                ...
                <h4 class="card-header text-center" >Bienvenue sur la page Administrateur</h4>
              <br>
            ...
            <div class="form-label-group">
                ...
                <br><br>
                     ...
                     <h6 style="text-align: center" >Vous n'êtes pas administateur ?</h6>
                     <div style="text-align: center">
                <a href="login.php">Veuiller vous connecter sur la page de connexion pour les utilisateurs</a>
                    </div>
