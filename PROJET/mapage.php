...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="mapageStyles.css">
</head> 
<!--<body>-->
  ...
  <div class="container">
   ...
   <div for="categorie" class="form-label-group">            
                ...
                <div style="margin-left: 50px" class="col" >
                    ...
                    <br>
                    <select name="categorie" id="categorie" class="text-center ; btn btn-primary dropdown-toggle">
                ...
                <input type="hidden" style="margin-top: 30px; ;" name="MAX_FILE_SIZE" value="2000000">
                Vidéo (max 2mo) : <input type="file" style="margin-top: 30px; ;" name="video"><br>

                <input type="number" style="margin-top: 30px;" name="prix" id="prix" placeholder="Prix">
                <label for="prix">€</label><br> <br><br>

                <input type="submit" id="bttnvalider" value="Mettre en vente" class="btn btn-lg btn-primary btn-block ">
